...
class TaskViewWidget extends StatefulWidget {
  TaskViewWidget(
      {Key? key, required this.taskEntry, required this.notifyChangeCb})
      : super(key: key);
...
class TaskViewState extends State<TaskViewWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
        color: widget.taskEntry.isPreview
            ? Colors.grey[300]
            : widget.taskEntry.isActive
                ? Colors.green[50]
                : null,
        child: Row(
          children: [
            MouseRegion(
                cursor: widget.taskEntry.description.isNotEmpty
                ...
                child: GestureDetector(
                  child: Row(mainAxisSize: MainAxisSize.max, children: [
                    Icon(
                      ...
                      color: widget.taskEntry.description.isEmpty
                          ? Colors.grey
                          : Colors.black,
                    ),
                    Column(
                  ...
                  onTap: widget.taskEntry.description.isNotEmpty
                      ? _toggleExpansion
                      : null,
                )),
            Row(
              children: [
                Chip(
                    label: Text(widget.taskEntry.estimateMin == 0
                        ? '?'
                        : widget.taskEntry.estimateMin.toString() + 'm')),
                IconButton(
                ...
                IconButton(
                  icon: Icon(widget.taskEntry.isActive
                      ? Icons.pause
